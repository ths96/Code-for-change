...
charity1 = Charity.create!(name: 'Save the Turtles', description:'Saving all the Turtles', location: 'Tulum, Mexico', user: user1)
...
charity2 = Charity.create!(name: 'Life of Giving', description:'Giving help to those who need it', location: 'London, UK', user: user2)
...
charity3 = Charity.create!(name: 'Justice League', description:'Fighting injustice', location: 'New York, USA', user: user3)
